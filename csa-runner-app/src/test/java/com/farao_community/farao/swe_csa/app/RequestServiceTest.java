...
class RequestServiceTest {
    ...
    void checkResultWhenCsaRunIsFinishedSecure() throws IOException, GlskLimitationException, ShiftingException {
        ...
        ParallelDichotomyResult parallelDichotomyResult = new ParallelDichotomyResult(new Pair<>(null, Status.FINISHED_SECURE), new Pair<>(null, Status.FINISHED_SECURE), new CounterTradingValues(1000, 200));

        when(dichotomyRunner.runDichotomy(csaRequest, "pt-es-rao-result-path", "fr-es-rao-result-path")).thenReturn(parallelDichotomyResult);
