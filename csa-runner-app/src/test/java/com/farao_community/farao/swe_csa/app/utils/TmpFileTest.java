...
public class TmpFileTest {
  ...
  @Test
  public void should_load_and_close() throws IOException {
    File f;
  ...
  @Test
  public void should_load_inputstream() throws IOException {
  ...
  @Test
  public void should_read() throws IOException {
    var res = getClass().getClassLoader().getResource("dummy.txt");
    try (var tmp = TmpFile.create(".tmp", new File(res.getFile()));
  ...
  @Test
  public void should_pretty_print() throws IOException {
  ...
  @Test
  public void should_fail_get_read_stream() throws IOException {
    try (var tmp = TmpFile.create(".tmp")) {
